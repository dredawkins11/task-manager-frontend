...
<style lang="scss">
  #about-body {
    ...
    display: grid;
    grid-template:
      "top-text top-text top-text top-text" 20px
      "repo1 repo1 repo2 repo2" 15px
      "back back back back" 15px;
    gap: 20px;
    left: 50%;
    top: 50%;
